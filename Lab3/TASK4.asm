...
;
; Function: Mimics car lights when turning and also breaks. 
; When interrupt is clicked a turn/break will be displayed and when released it will go back to normal.
;
; Output ports: PORTB
; Input port: PORTA
;
